...
import ResidentialRentalsInformation from "./CardInformation/Components/ResidentialRentals";
...
const PropertyCard: React.FC<Props> = ({ type, property }) => {
  ...
  return (
    <View style={{ width: width > SCREEN_BREAK_POINT ? 360 : width }} onTouchEnd={handlePress}>
